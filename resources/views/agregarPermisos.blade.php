...
<body class="container-fluid">
    ...
    <form id="formulario" action="{{ route('solicitud-ingreso.store') }}" method="POST">
        ...
        <h2 class="mb-4">Formulario de modificación de permisos</h2>
        <!-- Datos personales -->
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <div class="row text-start mx-auto">
                            ...
                            <div class="col-md-4">
                                <label for="Numero de identificación de la empresa">Nº de id de la
                                    empresa</label>
                                <input type="text" name="Numero_de_identificacion_de_la_empresa"
                                    placeholder="Nº de id de la empresa" required>
                            </div>
                            <div class="col-md-4">
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-content">
                        <div class="row g-4 justify-content-center">
                            <div class="col-md-6">
                                <label for="modo_acceso" class="form-label fw-bold">Modificar permisos de un usuario
                                    existente</label>
                                <select class="form-select" id="modo_acceso" name="modo_acceso" required>
                                    <option value="defauld" disabled selected>Seleccione agregar o eliminar permisos
                                    </option>
                                    <option value="nuevo">Agregar</option>
                                    <option value="existente">Eliminar</option>
                                </select>
                            </div>
                            <div class="col-md-4">
